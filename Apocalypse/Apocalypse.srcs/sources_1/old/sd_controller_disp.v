...
module sd_controller_disp(
    ...
    wire [31:0] img_cnt_digit1 = img_cnt / 10000000;
    wire [31:0] img_cnt_digit2 = (img_cnt % 10000000) / 1000000;
    wire [31:0] img_cnt_digit3 = (img_cnt % 1000000) / 100000;
    wire [31:0] img_cnt_digit4 = (img_cnt % 100000) / 10000;
    wire [31:0] img_cnt_digit5 = (img_cnt % 10000) / 1000;
    wire [31:0] img_cnt_digit6 = (img_cnt % 1000) / 100;
    wire [31:0] img_cnt_digit7 = (img_cnt % 100) / 10;
    wire [31:0] img_cnt_digit8 = (img_cnt % 10);
    ...
    always @ (posedge CLK100MHZ) begin
        ...
        if(~latch_n) begin
            ...
            if(((data_rx != 8'hff || data_rx != data_rx_history[7:0]) && done_rx) && (resp_startvalid == 0 || resp_bytecnt >= 508))begin
                //RX完成 && 检测到值的变化 -> 移位压入
