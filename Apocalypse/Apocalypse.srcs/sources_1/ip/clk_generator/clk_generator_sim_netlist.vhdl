...
-- Date        : Sat Jun 16 00:54:46 2018
-- Host        : SHUN-LAPTOP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Projects/CompArch/Apocalypse/Apocalypse.srcs/sources_1/ip/clk_generator/clk_generator_sim_netlist.vhdl
...
architecture STRUCTURE of clk_generator_clk_generator_clk_wiz is
  ...
  signal clk_cpu_clk_generator : STD_LOGIC;
  signal clk_vga_clk_generator : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_100MHz,
      O => clk_100MHz_clk_generator
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_vga_clk_generator,
      O => clk_vga
    );
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_cpu_clk_generator,
      O => clk_cpu
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKIN1 => clk_100MHz_clk_generator,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_vga_clk_generator,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_cpu_clk_generator,
