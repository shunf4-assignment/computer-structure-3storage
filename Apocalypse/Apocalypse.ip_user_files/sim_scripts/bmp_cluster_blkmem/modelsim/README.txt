...
#
# Generated by export_simulation on Wed Jun 13 16:02:27 +0800 2018
#
################################################################################
...
switch to the './bmp_cluster_blkmem.sh' script.

./bmp_cluster_blkmem.sh -reset_run
...
./bmp_cluster_blkmem.sh -noclean_files

For more information on the script, please type './bmp_cluster_blkmem.sh -help'.
