...
#
# Generated by export_simulation on Wed Jun 13 16:05:39 +0800 2018
#
################################################################################
...
switch to the './root_cluster.sh' script.

./root_cluster.sh -reset_run
...
./root_cluster.sh -noclean_files

For more information on the script, please type './root_cluster.sh -help'.
